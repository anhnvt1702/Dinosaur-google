...
impl SpritePreset {
    ...
    pub fn filepath(&self) -> PathBuf {
        match self {
            SpritePreset::Dino => "sprite/racing/dino.png",
            SpritePreset::Tree => "sprite/racing/tree.png",
    ...
    pub fn variant_iter() -> IntoIter<SpritePreset, 3> {
        static SPRITE_PRESETS: [SpritePreset; 3] = [
            SpritePreset::Dino,
            SpritePreset::Tree,
